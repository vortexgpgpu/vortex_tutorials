...
- Since software prefetch is currently not supported by the RISC-V toolchain, you will start by inserting the instruction in /Vortex/runtime/include/vx_intrinsics.h using assembly code.
